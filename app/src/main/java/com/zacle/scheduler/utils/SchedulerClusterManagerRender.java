...
public class SchedulerClusterManagerRender extends DefaultClusterRenderer<ClusterMarker> {
    ...
    public SchedulerClusterManagerRender(Context context, GoogleMap googleMap,
